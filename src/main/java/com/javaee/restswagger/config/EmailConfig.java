...
public class EmailConfig {
	...
	private void configContent(String toEmail, String subject, String body, MimeMessage message) {
		try {
			message.setFrom(new InternetAddress("flaviopedrosa@gmail.com", "Trabalho Final JavaEE"));
			message.setReplyTo(InternetAddress.parse("flaviopedrosa@gmail.com", false));
